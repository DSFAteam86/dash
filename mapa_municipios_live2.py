...
cluster_options = [{'label':'AMAZONAS','value':'AMAZONAS'},
                   {'label':'ANTIOQUIA','value':'ANTIOQUIA'},
                   {'label':'ARAUCA','value':'ARAUCA'},
                   {'label':'ATLANTICO','value':'ATLANTICO'},
                   {'label':'BOGOTA DC','value':'BOGOTA DC'},
                   ...
                   {'label':'SAN ANDRES, PROVIDENCIA Y SANTA CATALINA','value':'SAN ANDRES, PROVIDENCIA Y SANTA CATALINA'},
